...
const CriarLaudoPreventiva = () => {
  ...
  const handleCadastrarLaudoPreventivaClick = async () => {
    try {
      const data = {
      ...
      const response = await axios.post('http://localhost:8080/pdf/laudoPreventiva', data, {
        responseType: 'blob'
      });
      ...
      <Box className="form-container">
        ...
        <Box className="form-fields-container">
          ...
          <Box className="button-container">
            <Button
              type="button"
              onClick={handleCadastrarLaudoPreventivaClick}
              variant="contained"
              endIcon={<SendIcon />}
              className="button"
            >
...
export default CriarLaudoPreventiva;
